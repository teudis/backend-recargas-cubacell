...
namespace WebApplication.Controllers.Mananagement
{
    ...
    public class CellularBalanceTuneUpRecordController : AbstractEntityManagementController<CellularBalanceTuneUpRecord, long, CellularBalanceTuneUpRecordInputModelView, CellularBalanceTuneUpRecordDisplayViewModel>
    {
        public CellularBalanceTuneUpRecordController(IEntityRepository<CellularBalanceTuneUpRecord, long> repository, IStringLocalizer<CellularBalanceTuneUpRecordController> localizer, ILogger<CellularBalanceTuneUpRecordController> logger) : base(repository, localizer, logger)
        {
        }
